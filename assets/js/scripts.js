    ...
    $document.ready(function () {
        ...
        if ($.fn.owlCarousel) {
            ...
            $("#portfolio-carousel").owlCarousel({
                ...
                pagination: false,
                autoHeight : true,
                navigationText: ['<i class="fas fa-long-arrow-alt-left" style="align: middle;"><span>&nbsp;&nbsp; Prev &nbsp;&nbsp;</span></i>', '<i class="fas fas-long-arrow-alt-right" style="align: middle;"><span>&nbsp;&nbsp; Next &nbsp;&nbsp;</span></i><i class="fas fa-long-arrow-alt-right" style="align: middle;"></i>']
            ...
            $("#portfolio-carousel-alt").owlCarousel({
                ...
                navigation: true,
                pagination: false,
                navigationText: ['<i class="fas fa-long-arrow-alt-left" style="align: middle;"></i>', '<i class="fas fa-long-arrow-alt-right" style="align: middle;"></i>']
            });
        }
        ...
        /*==============================================
         Back to top init
         ===============================================*/
        $body.append("<a data-scroll class='lift-off js-lift-off lift-off_hide' href='#'><i class='far fa-arrow-alt-circle-up'></i>");
